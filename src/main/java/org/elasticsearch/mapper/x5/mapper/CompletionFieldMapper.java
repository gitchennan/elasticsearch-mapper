...
import org.elasticsearch.mapper.x5.annotations.fieldtype.CompletionContext;
import org.elasticsearch.mapper.x5.annotations.fieldtype.CompletionField;
...
public class CompletionFieldMapper {
    ...
    public static boolean isValidCompletionFieldType(Field field) {
        ...
        return String.class.isAssignableFrom(fieldClass) && field.isAnnotationPresent(CompletionField.class);
    }
